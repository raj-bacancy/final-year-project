...
<div style="border:2px solid orange;border-radius:5%" class="bg-white mx-auto p-5 bottom_space">
		   			...
		   			<h2 class="text-center"><b>De-allocate Room</b></h2>
	   			<hr>
		   				<div class="row">
        ...
        <c:forEach items="${list}" var="i">	
					...
					<td><center><b><a href="deallocate.html?id=${i.id}&&allocatedroom=${i.allocatedroom}&&noofguest=${i.noofguest}"><button class="btn btn-danger">De-allocate Room</button></a></b></center></td>			
					</tr>
					</c:forEach> 		
...
<%-- <div style="height:auto;width:60%;margin-top:5%;margin-left:30%;border:2px solid orange;border-radius:5%" class="bg-light">
			   	...
			   	<table class="table table-stripped table-hover table-bordered">
					...
					<td><b>${i.noofguest}</b></td>
					<td><b>${i.roomtype}</b></td>
					<td><center><b><a href="deallocate.html?id=${i.id}&&allocatedroom=${i.allocatedroom}&&noofguest=${i.noofguest}"><button class="btn btn-success">De-allocate Room</button></a></b></center></td>			
					</tr>
					</c:forEach> 		   			
				</table>
		   	</div>
