...
<div style="border:2px solid orange;border-radius:5%" class="bg-white mx-auto p-5 bottom_space">
		   			...
		   			<h2 class="text-center"><b>Complain Status</b></h2>
	   			<hr>
		   				<div class="row">
       ...
       <c:forEach items="${list5 }" var="i">	
			...
			<td><b>${i.date }</b></td>
			<td><b>${i.status}</b></td>
			<td><b><a style="color:blue" href="viewcomplainreply.html?hostelid=${i.hostelid}&date=${i.date}">View Reply</a></b></td>
			</tr>
			</c:forEach> 
...
<%-- <div style="height:auto;width:60%;margin-top:5%;margin-left:30%;border:2px solid orange;border-radius:5%" class="bg-light">
	   			<h2 class="pt-4 text-center "><b> Complain Status</b></h2>
	   			<hr>
			...
			<td><b>${i.date }</b></td>
			<td><b>${i.status}</b></td>
			<td><b><a href="viewcomplainreply.html?hostelid=${i.hostelid}&date=${i.date}">View Reply</a></b></td>
			</tr>
			</c:forEach> 
