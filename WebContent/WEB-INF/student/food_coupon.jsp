    ...
    <div class="col-sm-12 col-12 text-center" style="margin:90px 0px " >
        <div class="row">
            <div class="col-sm-6 col-12 p-1 mb-5">
                <a href="todaymenu.html"><div class="card box mx-auto" style="box-shadow: 10px 10px 20px 10px rgba(1, 1, 1, .1);border:2px solid orange;width: 70%;border-radius:7%">
            ...
            <div class="col-sm-6 col-12 p-1">
                 <a href="foodstatus.html"><div class="card box mx-auto" style="box-shadow: 10px 10px 20px 10px rgba(1, 1, 1, .1);border:2px solid orange;width:70%;border-radius:7%">
